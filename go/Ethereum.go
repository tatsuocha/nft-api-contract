...
var EthereumMetaData = &bind.MetaData{
	ABI: "[{\"constant\":true,\"inputs\":[],\"name\":\"get\",\"outputs\":[{\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"x\",\"type\":\"uint256\"}],\"name\":\"create\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
}
...
func (_Ethereum *EthereumCaller) Get(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Ethereum.contract.Call(opts, &out, "get")
...
//
// Solidity: function get() view returns(uint256)
func (_Ethereum *EthereumSession) Get() (*big.Int, error) {
	return _Ethereum.Contract.Get(&_Ethereum.CallOpts)
}

// Get is a free data retrieval call binding the contract method 0x6d4ce63c.
//
// Solidity: function get() view returns(uint256)
func (_Ethereum *EthereumCallerSession) Get() (*big.Int, error) {
	return _Ethereum.Contract.Get(&_Ethereum.CallOpts)
}

// Create is a paid mutator transaction binding the contract method 0x780900dc.
//
// Solidity: function create(uint256 x) returns()
func (_Ethereum *EthereumTransactor) Create(opts *bind.TransactOpts, x *big.Int) (*types.Transaction, error) {
	return _Ethereum.contract.Transact(opts, "create", x)
}

// Create is a paid mutator transaction binding the contract method 0x780900dc.
//
// Solidity: function create(uint256 x) returns()
func (_Ethereum *EthereumSession) Create(x *big.Int) (*types.Transaction, error) {
	return _Ethereum.Contract.Create(&_Ethereum.TransactOpts, x)
}

// Create is a paid mutator transaction binding the contract method 0x780900dc.
//
// Solidity: function create(uint256 x) returns()
func (_Ethereum *EthereumTransactorSession) Create(x *big.Int) (*types.Transaction, error) {
	return _Ethereum.Contract.Create(&_Ethereum.TransactOpts, x)
}
